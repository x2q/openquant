...
public class TimeBasedStopSellIntent extends SellIntent {
	
	private int decrementor;
	
	private int dayBarCount;

	public TimeBasedStopSellIntent(int dayBarCount, double price, int quantity, Position position, OrderTimeFrame timeframe,
	...
	public TimeBasedStopSellIntent(int dayBarCount, double price, int quantity, Position position, OrderCallback callback) {
